...
export CASSANDRA_TOOL=/var/vcap/packages/cassandra/tools
...
pushd /var/vcap/packages/cassandra/tools
exec chpst -u vcap:vcap /var/vcap/packages/cassandra/tools/cassandra-stress write n=10 
popd
exit 0
